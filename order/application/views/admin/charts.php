...
<div class="primary-sidebar">
  ...
  <ul class="nav nav-collapse collapse nav-collapse-primary">
            ...
            <li class="dark-nav ">
              ...
              <a class="accordion-toggle collapsed " data-toggle="collapse" href="#SxZnt6tgfv">
              ...
              <ul id="SxZnt6tgfv" class="collapse ">
            ...
            <li class="dark-nav ">
              ...
              <a class="accordion-toggle collapsed " data-toggle="collapse" href="#HbdSck7zKL">
              ...
              <ul id="HbdSck7zKL" class="collapse ">
  ...
  <div class="hidden-tablet hidden-phone">
    ...
    <div class="sparkline-box side">
      ...
      <div class="sparkline-row">
        ...
        <div class="sparkline big" data-color="gray"><!--16,13,16,3,11,15,17,27,20,18,12,24--></div>
      </div>

      <hr class="divider">
      <div class="sparkline-row">
        <h4 class="dark-green"><span>Income</span> $43.330</h4>
        <div class="sparkline big" data-color="darkGreen"><!--19,26,11,5,16,3,24,5,21,13,24,9--></div>
      </div>

      <hr class="divider">
      <div class="sparkline-row">
        <h4 class="blue"><span>Reviews</span> 223</h4>
        <div class="sparkline big" data-color="blue"><!--18,26,29,6,24,19,7,16,24,4,10,13--></div>
      </div>
...
<div class="box">
  ...
  <div class="box-content padded" style="text-align: center">
    ...
    <div class="justgage" data-title="No labels" data-labels="false" id="ETsrgwKQPL"></div>
    <div class="justgage" data-title="Custom Width" data-gauge-width-scale="0.2" id="xTZ3nv3XCK"></div>
    <div class="justgage" data-title="Custom Animation" data-animation-type="bounce" id="GyxDLr9vjW"></div>
  </div>
</div>
  ...
  <div class="box-content padded">
    <div class="row-fluid separate-sections">
      ...
      <div class="span2 separate-sections text-center">
        <div class="sparkline big"><!--21,11,6,16,28,20,8,23,5,19,13,9--></div>
        <div class="sparkline big" data-color="blue"><!--28,15,22,8,8,6,9,13,7,16,22,3--></div>
        <div class="sparkline big" data-color="orange"><!--28,5,9,28,12,21,29,18,22,13,3,11--></div>
        <div class="sparkline big" data-color="green"><!--16,17,23,7,22,24,25,24,21,5,12,13--></div>
      </div>
    </div>
