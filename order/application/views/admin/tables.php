...
<div class="primary-sidebar">
  ...
  <ul class="nav nav-collapse collapse nav-collapse-primary">
            ...
            <li class="dark-nav active">
              ...
              <a class="accordion-toggle  " data-toggle="collapse" href="#3TVKua3zcM">
              ...
              <ul id="3TVKua3zcM" class="collapse in">
            ...
            <li class="dark-nav ">
              ...
              <a class="accordion-toggle collapsed " data-toggle="collapse" href="#5WzhqZ9z2S">
              ...
              <ul id="5WzhqZ9z2S" class="collapse ">
  ...
  <div class="hidden-tablet hidden-phone">
    ...
    <div class="sparkline-box side">
      ...
      <div class="sparkline-row">
        ...
        <div class="sparkline big" data-color="gray"><!--22,28,20,10,12,3,23,4,5,19,25,19--></div>
      </div>

      <hr class="divider">
      <div class="sparkline-row">
        <h4 class="dark-green"><span>Income</span> $43.330</h4>
        <div class="sparkline big" data-color="darkGreen"><!--15,26,15,23,4,7,27,14,10,21,10,22--></div>
      </div>

      <hr class="divider">
      <div class="sparkline-row">
        <h4 class="blue"><span>Reviews</span> 223</h4>
        <div class="sparkline big" data-color="blue"><!--16,29,14,18,23,11,5,26,3,14,15,24--></div>
      </div>
      ...
      <div class="area-top clearfix">
        ...
        <ul class="inline pull-right sparkline-box">
          ...
          <li class="sparkline-row">
            ...
            <div class="sparkline big" data-color="blue"><!--17,24,19,18,7,28,16,25,8,7,5,11--></div>
          </li>

          <li class="sparkline-row">
            <h4 class="green"><span>Reviews</span> 223</h4>
            <div class="sparkline big" data-color="green"><!--25,28,21,19,8,6,27,24,13,18,29,12--></div>
          </li>

          <li class="sparkline-row">
            <h4 class="red"><span>New visits</span> 7930</h4>
            <div class="sparkline big"><!--7,12,14,9,16,15,9,11,11,22,20,19--></div>
          </li>
  ...
  <div class="box-content">
    <table class="table table-normal">
      ...
      <tr>
        ...
        <td style="text-align: center;"><i class="icon-user"></i> Visitors</td>
        <td class="status-error"><i class="icon-circle-arrow-down"></i> -5%</td>
      </tr>

      <tr>
        <td style="width: 60px;"><div class="sparkline" data-color="green"><!--5,6,8,14,18,10,12,16,15,16,12,15--></div></td>
        <td style="text-align: center;"><i class="icon-comments-alt"></i> Comments</td>
        <td class="status-success"><i class="icon-circle-arrow-up"></i> +10%</td>
      </tr>

      <tr>
        <td style="width: 60px;"><div class="sparkline"><!--15,16,8,14,18,10,14,16,15,16,12,10--></div></td>
        <td style="text-align: center;"><i class="icon-bell"></i> Events</td>
        <td class="status-error"><i class="icon-circle-arrow-down"></i> -15%</td>
      </tr>

      <tr>
        <td style="width: 60px;"><div class="sparkline" data-color="green"><!--8,11,12,23,14,16,12,18,15,16,12,20--></div></td>
        <td style="text-align: center;"><i class="icon-money"></i> Income</td>
        <td class="status-success"><i class="icon-circle-arrow-up"></i> +20%</td>
      </tr>
