...
<div class="primary-sidebar">
  ...
  <ul class="nav nav-collapse collapse nav-collapse-primary">
            ...
            <li class="dark-nav ">
              ...
              <a class="accordion-toggle collapsed " data-toggle="collapse" href="#PewVe76zrf">
              ...
              <ul id="PewVe76zrf" class="collapse ">
            ...
            <li class="dark-nav active">
              ...
              <a class="accordion-toggle  " data-toggle="collapse" href="#vE78xcAPsT">
              ...
              <ul id="vE78xcAPsT" class="collapse in">
  ...
  <div class="hidden-tablet hidden-phone">
    ...
    <div class="sparkline-box side">
      ...
      <div class="sparkline-row">
        ...
        <div class="sparkline big" data-color="gray"><!--8,3,13,18,16,15,5,11,20,8,28,28--></div>
      </div>

      <hr class="divider">
      <div class="sparkline-row">
        <h4 class="dark-green"><span>Income</span> $43.330</h4>
        <div class="sparkline big" data-color="darkGreen"><!--10,16,20,28,19,7,5,24,12,14,12,28--></div>
      </div>

      <hr class="divider">
      <div class="sparkline-row">
        <h4 class="blue"><span>Reviews</span> 223</h4>
        <div class="sparkline big" data-color="blue"><!--21,23,17,23,20,11,11,8,10,28,16,22--></div>
      </div>
